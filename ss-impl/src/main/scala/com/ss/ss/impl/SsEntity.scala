...
/**
  * This is an event sourced entity. It has a state, [[SsState]], which
  ...
  */
class SsEntity extends PersistentEntity {

  override type Command = SsCommand[_]
  override type Event = SsEvent
  override type State = SsState

  /**
    * The initial state. This is used if there is no snapshotted state to be found.
    */
  override def initialState: SsState = SsState("Hello", LocalDateTime.now.toString)
  ...
  override def behavior: Behavior = {
    case SsState(message, _) => Actions().onCommand[UseGreetingMessage, Done] {
      ...
      case (GreetingMessageChanged(newMessage), state) =>
        ...
        // the event.
        SsState(newMessage, LocalDateTime.now().toString)
...
/**
  ...
  */
case class SsState(message: String, timestamp: String)
...
object SsState {
  /**
    ...
    */
  implicit val format: Format[SsState] = Json.format
}

/**
  * This interface defines all the events that the SsEntity supports.
  */
sealed trait SsEvent

/**
  * An event that represents a change in greeting message.
  */
case class GreetingMessageChanged(message: String) extends SsEvent
...
/**
  ...
  */
sealed trait SsCommand[R] extends ReplyType[R]
...
/**
  ...
  */
case class UseGreetingMessage(message: String) extends SsCommand[Done]
...
/**
  ...
  * person.
  */
case class Hello(name: String, organization: Option[String]) extends SsCommand[String]
...
/**
  ...
  * application loader.
  */
object SsSerializerRegistry extends JsonSerializerRegistry {
  override def serializers: Seq[JsonSerializer[_]] = Seq(
    JsonSerializer[UseGreetingMessage],
    JsonSerializer[Hello],
    JsonSerializer[GreetingMessageChanged],
    JsonSerializer[SsState]
  )
}
